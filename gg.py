...
loag = f"""{wwn}____________________________________		{K}•{C}━━━━━━━━━━━━━━━━━━━━{K}•{Q}
{wwn}______  /___   |/  /___ __ )___ ____/		{K}•{M}  Created By Alzwage{K}•{Q}
{wwn}___ _  / __  /|_/ / __  __  |__ /_		{K}•{M} Mode In Libya® {K}•{Q}
...
#		exit(jalan(war+"Hapus Useragent Berhasil, Dan Anda Menggunakan Useragent Default"))
	...
	print(C+"["+P+"01"+C+"]"+P+" MULTI__PUBLIC")
	print(C+"["+P+"02"+C+"]"+P+" MULTI__FOLOWER")
	print(C+"["+P+"03"+C+"]"+P+" P_F")
...
def buat_laporan():
	...
	url_wa = "https://api.whatsapp.com/send?phone=+218921762445&text="
	tks = ("Halo Admin Jmbf :)\nInfo : \nNama Pengirim : "+anu+"\n\nPesan (Laporan) : "+anun)
...
class crackmenu:
    ...
    def passmenu(self,isifile):
        ...
        if zk in ('m','M','Manual','manual'):
            while True:
                jalan(war+"Contoh Password :123456")
                pwx = input('\n'+inp+"Masukan Password : ")
                jalan("%sPassword Yang DiGunakan : %s%s"%(war,I,pwx))
                if pwx == '':
                    jalan(war+"Isi Password Dengan Benar !!")
